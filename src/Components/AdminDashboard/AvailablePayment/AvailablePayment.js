    ...
    return (
        <div className='row'>
            <div className='col-md-12'>
                <h3 className='page_title'>Available Payment</h3>
            </div>
            <div className="col-12 col-sm-6 col-xl-4 grid-margin">
                <div className="card upper_cards avaiable_payment_upper_cards">
                        ...
                        <div className='row mx-1'>
                            ...
                            <div className='col-md-10'>
                                <div className='upper_card_title pt-2'>
                                    ...
                                    <p className='sub_title'>BTC <span>0x68B3928850C7896E11935CF97...</span></p>
                                </div>
                            </div>
            ...
            <div className='col-md-12'>
                <table class="table pending_approval_table mt-4">
                    ...
                    <tbody>
                        <tr>
                            <td className='game_name'><img src="/eye.svg" alt="" /> 0x8a184ec8412f5..</td>
                            <td className='approval_type'><div className='payment'>Payment</div></td>
                            <td className='game_name'>24343332</td>
                            <td className='game_name'>10 hrs 39 mins ago..</td>
                            <td className='game_name'>0x8a184ec8412f5..</td>
                            <td className='game_name'><img src="/in.svg" alt="" /> Cub Finance: CUB Token</td>
                            <td className='game_name'>0 BNB</td>
                            <td className='game_name'>0.000222515</td>
                            <hr />
                        </tr>
                        <tr>
                            <td className='game_name'><img src="/eye.svg" alt="" /> 0x8a184ec8412f5..</td>
